...
export CNDT_ROUTER_CACHE_EXPIRE_TIME=1
...
export OTEL_EXPORTER_OTLP_HEADERS="Authorization=Basic%20cm9vdEBleGFtcGxlLmNvbTpDb21wbGV4cGFzcyMxMjMK"
...
export CNDT_EASTERN_API_MEMCACHE_EXPIRE_TIME=1
...
export CNDT_WESTERN_API_MEMCACHE_EXPIRE_TIME=1
...
- Usage
```sh
export OTEL_SERVICE_NAME=CNDT-WESTERN-API
export OTEL_TRACES_EXPORTER=otlp
export OTEL_METRICS_EXPORTER=otlp
export OTEL_LOGS_EXPORTER=otlp
export OTEL_EXPORTER_OTLP_PROTOCOL=grpc
